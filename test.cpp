...
static void dump_std_video_h264_sps_flags(const StdVideoH264SpsFlags *flags)
{
    ...
    print_integer("mb_adaptive_frame_field_flag", flags->mb_adaptive_frame_field_flag);
    print_integer("frame_mbs_only_flag", flags->frame_mbs_only_flag);
    print_integer("delta_pic_order_always_zero_flag", flags->delta_pic_order_always_zero_flag);
    print_integer("separate_colour_plane_flag", flags->separate_colour_plane_flag);
    print_integer("gaps_in_frame_num_value_allowed_flag", flags->gaps_in_frame_num_value_allowed_flag);
    print_integer("qpprime_y_zero_transform_bypass_flag", flags->qpprime_y_zero_transform_bypass_flag);
    print_integer("frame_cropping_flag", flags->frame_cropping_flag);
    print_integer("seq_scaling_matrix_present_flag", flags->seq_scaling_matrix_present_flag);
    print_integer("vui_parameters_present_flag", flags->vui_parameters_present_flag);
    end_object();
}

static void dump_std_video_h264_scaling_lists(const StdVideoH264ScalingLists *lists)
{
    start_object("StdVideoH264ScalingLists");
    print_integer("scaling_list_present_mask", lists->scaling_list_present_mask);
    print_integer("use_default_scaling_matrix_mask", lists->use_default_scaling_matrix_mask);
...
static void dump_std_video_h264_sps_vui_flags(const StdVideoH264SpsVuiFlags *flags)
{
    start_object("StdVideoH264SpsVuiFlags");
    print_integer("aspect_ratio_info_present_flag", flags->aspect_ratio_info_present_flag);
    print_integer("overscan_info_present_flag", flags->overscan_info_present_flag);
    print_integer("overscan_appropriate_flag", flags->overscan_appropriate_flag);
    print_integer("video_signal_type_present_flag", flags->video_signal_type_present_flag);
    print_integer("video_full_range_flag", flags->video_full_range_flag);
    print_integer("color_description_present_flag", flags->color_description_present_flag);
    print_integer("chroma_loc_info_present_flag", flags->chroma_loc_info_present_flag);
    ...
    print_integer("bitstream_restriction_flag", flags->bitstream_restriction_flag);
    print_integer("nal_hrd_parameters_present_flag", flags->nal_hrd_parameters_present_flag);
    print_integer("vcl_hrd_parameters_present_flag", flags->vcl_hrd_parameters_present_flag);
    end_object();
}

static void dump_std_video_h264_sps_vui(const StdVideoH264SequenceParameterSetVui* vui)
{
...
static void dump_std_video_h264_sps(const StdVideoH264SequenceParameterSet* pH264Sps)
{
    ...
    print_integer("log2_max_frame_num_minus4", pH264Sps->log2_max_frame_num_minus4);
    print_integer("pic_order_cnt_type", pH264Sps->pic_order_cnt_type);
    print_integer("log2_max_pic_order_cnt_lsb_minus4", pH264Sps->log2_max_pic_order_cnt_lsb_minus4);
    print_integer("offset_for_non_ref_pic", pH264Sps->offset_for_non_ref_pic);
    print_integer("offset_for_top_to_bottom_field", pH264Sps->offset_for_top_to_bottom_field);
    print_integer("num_ref_frames_in_pic_order_cnt_cycle", pH264Sps->num_ref_frames_in_pic_order_cnt_cycle);
    ...
    print_integer("pic_height_in_map_units_minus1", pH264Sps->pic_height_in_map_units_minus1);
    ...
    print_integer("frame_crop_bottom_offset", pH264Sps->frame_crop_bottom_offset);
...
static void dump_std_video_h264_pps_flags(const StdVideoH264PpsFlags* flags)
{
    start_object("StdVideoH264PpsFlags");
    print_integer("transform_8x8_mode_flag", flags->transform_8x8_mode_flag);
    print_integer("redundant_pic_cnt_present_flag", flags->redundant_pic_cnt_present_flag);
    print_integer("constrained_intra_pred_flag", flags->constrained_intra_pred_flag);
    print_integer("deblocking_filter_control_present_flag", flags->deblocking_filter_control_present_flag);
    ...
    print_integer("pic_scaling_matrix_present_flag", flags->pic_scaling_matrix_present_flag);
    end_object();
}

static void dump_std_video_h264_pps(const StdVideoH264PictureParameterSet* pps)
{
    ...
    print_integer("num_ref_idx_l0_default_active_minus1", pps->num_ref_idx_l0_default_active_minus1);
    print_integer("num_ref_idx_l1_default_active_minus1", pps->num_ref_idx_l1_default_active_minus1);
    ...
    print_integer("second_chroma_qp_index_offset", pps->second_chroma_qp_index_offset);
    if (pps->pScalingLists)
        dump_std_video_h264_scaling_lists(pps->pScalingLists);
    end_object();
}

static void dump_picture_parameters(VkPictureParameters* params)
{
...
static void dump_parser_sequence_info(const VkParserSequenceInfo *info)
{
    ...
    end_array();
    print_string("pbSideData", "%s", ""); //uint8_t* pbSideData; // Auxiliary encryption information
    print_integer("cbSideData", info->cbSideData); // Auxiliary encryption information length
    end_object();
}

static void dump_parser_h264_dpb_entry(const VkParserH264DpbEntry * entry)
{
...
static void dump_parser_h264_picture_data(const VkParserH264PictureData * data)
{
    ...
    print_integer("num_ref_idx_l0_active_minus1", data->num_ref_idx_l0_active_minus1);
    print_integer("num_ref_idx_l1_active_minus1", data->num_ref_idx_l1_active_minus1);
    ...
    print_integer("redundant_pic_cnt_present_flag", data->redundant_pic_cnt_present_flag);
    print_integer("deblocking_filter_control_present_flag", data->deblocking_filter_control_present_flag);
    print_integer("transform_8x8_mode_flag", data->transform_8x8_mode_flag);
    print_integer("MbaffFrameFlag", data->MbaffFrameFlag);
    print_integer("constrained_intra_pred_flag", data->constrained_intra_pred_flag);
    ...
    print_integer("second_chroma_qp_index_offset", data->second_chroma_qp_index_offset);
    ...
    print_integer("slice_group_change_rate_minus1", data->slice_group_change_rate_minus1);
...
static void dump_parser_picture_data(VkParserPictureData* pic)
{
