...
void dump_picture_parameters(VkPictureParameters* params)
{
...
void dump_parser_sequence_info(const VkParserSequenceInfo *info)
{
...
void dump_parser_picture_data(VkParserPictureData* pic)
{
